...
public class CalculatorBox extends JFrame {
    ...
    JButton btnAdd, btnSubtract, btnDivide, btnMultiply, btnClear, btnDelete, btnEquals, btnSine, btnCos, btnTan,
            btnDot;
    JButton numBtn[];
    JTextField output;
    ...
    public CalculatorBox() {
        ...
        btnSine.setFont(new Font("Monospaced", Font.ITALIC, 18));
        btnCos.setFont(new Font("Monospaced", Font.ITALIC, 18));
        btnTan.setFont(new Font("Monospaced", Font.ITALIC, 18));
        ...
        btnSine.addActionListener(opBtnHandler);
        btnCos.addActionListener(opBtnHandler);
        btnTan.addActionListener(opBtnHandler);
